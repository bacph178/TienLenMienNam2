...
class BINRoomPlay : public ::google::protobuf::Message {
 public:
  ...
  static const int kRoomCapacityFieldNumber = 6;
  ...
  static const int kEnteringPlayerFieldNumber = 7;
  ...
  static const int kOwnerUserNameFieldNumber = 10;
  ...
  inline bool has_viproom() const;
  inline void clear_viproom();
  static const int kVipRoomFieldNumber = 11;
  inline bool viproom() const;
  inline void set_viproom(bool value);
  ...
  static const int kPasswordRequiredFieldNumber = 12;
