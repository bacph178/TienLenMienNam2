...
void protobuf_AssignDesc_filter_5froom_2eproto() {
  ...
  static const int BINRoomPlay_offsets_[12] = {
...
void protobuf_AddDesc_filter_5froom_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\014orderByField\030\005 \001(\005\022\013\n\003asc\030\006 \001(\010\"\363\001\n\013BIN"
    "RoomPlay\022\021\n\troomIndex\030\001 \002(\005\022\020\n\010roomName\030"
    "\002 \002(\t\022\016\n\006roomId\030\003 \002(\003\022\023\n\013roomGroupId\030\004 \002"
    "(\005\022\016\n\006minBet\030\005 \002(\005\022\024\n\014roomCapacity\030\006 \002(\005"
    "\022\026\n\016enteringPlayer\030\007 \002(\005\022\r\n\005level\030\010 \002(\005\022"
    "\013\n\003tax\030\t \002(\005\022\025\n\rownerUserName\030\n \001(\t\022\017\n\007v"
    "ipRoom\030\013 \002(\010\022\030\n\020passwordRequired\030\014 \002(\010\"_"
    "\n\025BINFilterRoomResponse\022\024\n\014responseCode\030"
    "\001 \002(\010\022\017\n\007message\030\002 \001(\t\022\037\n\troomPlays\030\003 \003("
    "\0132\014.BINRoomPlayB\036\n\034com.mi.game.network.d"
    "ata.bin", 527);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_roomCapacity;
        break;
      }

      // required int32 roomCapacity = 6;
      case 6: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_roomCapacity:
        ...
        if (input->ExpectTag(56)) goto parse_enteringPlayer;
        break;
      }

      // required int32 enteringPlayer = 7;
      case 7: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(82)) goto parse_ownerUserName;
        break;
      }

      // optional string ownerUserName = 10;
      case 10: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_ownerUserName:
        ...
        if (input->ExpectTag(88)) goto parse_vipRoom;
        break;
      }

      // required bool vipRoom = 11;
      case 11: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_vipRoom:
        ...
        if (input->ExpectTag(96)) goto parse_passwordRequired;
        break;
      }

      // required bool passwordRequired = 12;
      case 12: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
...
void BINRoomPlay::SerializeWithCachedSizes(
  ...
  // required int32 roomCapacity = 6;
  if (has_roomcapacity()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(6, this->roomcapacity(), output);
  }

  // required int32 enteringPlayer = 7;
  if (has_enteringplayer()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(7, this->enteringplayer(), output);
  }
  ...
  if (has_ownerusername()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
      ...
      ::google::protobuf::internal::WireFormat::SERIALIZE);
    ::google::protobuf::internal::WireFormatLite::WriteString(
      10, this->ownerusername(), output);
  }

  // required bool vipRoom = 11;
  if (has_viproom()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(11, this->viproom(), output);
  }

  // required bool passwordRequired = 12;
  if (has_passwordrequired()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(12, this->passwordrequired(), output);
  }
...
::google::protobuf::uint8* BINRoomPlay::SerializeWithCachedSizesToArray(
  ...
  // required int32 roomCapacity = 6;
  if (has_roomcapacity()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(6, this->roomcapacity(), target);
  }

  // required int32 enteringPlayer = 7;
  if (has_enteringplayer()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(7, this->enteringplayer(), target);
  }
  ...
  if (has_ownerusername()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        10, this->ownerusername(), target);
  }

  // required bool vipRoom = 11;
  if (has_viproom()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(11, this->viproom(), target);
  }

  // required bool passwordRequired = 12;
  if (has_passwordrequired()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(12, this->passwordrequired(), target);
  }
